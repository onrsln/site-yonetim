  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Bloklar</h1>
          <p className="text-gray-500 mt-1 text-lg">Tüm blokları görüntüleyin ve yönetin</p>
        </div>
      ...
      {filteredBlocks.length === 0 ? (
        <ModernCard className="flex flex-col items-center justify-center py-16 text-center" variant="bordered">
          ...
          <h3 className="text-xl font-semibold text-gray-900">Blok bulunamadı</h3>
          ...
          {filteredBlocks.map((block) => (
            <ModernCard key={block.id} hover padding="none" className="overflow-hidden group">
              ...
              <div className="pt-10 px-6 pb-6">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">{block.name}</h3>
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  <div className="p-3 rounded-xl bg-gray-50 border border-gray-100">
                    ...
                    <span className="text-lg font-bold text-gray-900">{block._count.floors}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-gray-50 border border-gray-100">
                    <div className="flex items-center gap-2 text-gray-500 mb-1">
                    ...
                    <span className="text-lg font-bold text-gray-900">{block._count.apartments}</span>
                  </div>
                </div>
