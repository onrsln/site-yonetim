  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Ortak Alanlar</h1>
          <p className="text-slate-400 mt-1 text-lg">Tüm ortak alanları görüntüleyin ve yönetin</p>
        </div>
      ...
      {filteredAreas.length === 0 ? (
        <ModernCard className="flex flex-col items-center justify-center py-16 text-center" variant="bordered">
          ...
          <h3 className="text-xl font-semibold text-white">Ortak alan bulunamadı</h3>
              ...
              <div className="pt-10 px-6 pb-6">
                <div>
                  <div className="flex justify-between items-start">
                    <h3 className="text-xl font-bold text-white group-hover:text-green-600 transition-colors">
                      {area.name}
                    </h3>
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  <div className="p-3 rounded-xl bg-slate-800/30 border border-white/10">
                    ...
                    <span className="text-lg font-bold text-white">{area._count.items}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-800/30 border border-white/10">
                    <div className="flex items-center gap-2 text-slate-400 mb-1">
                    ...
                    <span className="text-lg font-bold text-white">{area._count.issues}</span>
                  </div>
                </div>
              </div>
            </ModernCard>
